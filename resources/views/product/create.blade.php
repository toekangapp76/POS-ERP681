    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('revenue_account_id', $accounting_accounts, !empty($duplicate_product->revenue_account_id) ? $duplicate_product->revenue_account_id : null, [
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('inventory_account_id', $accounting_accounts, !empty($duplicate_product->inventory_account_id) ? $duplicate_product->inventory_account_id : null, [
                    'class' => 'form-control select2',
                    'style' => 'width: 100%',
                    'placeholder' => __('messages.please_select'),
                ]) !!}
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('tax_account_id', $accounting_accounts, !empty($duplicate_product->tax_account_id) ? $duplicate_product->tax_account_id : null, [
                    'class' => 'form-control select2',
                    'style' => 'width: 100%',
                    'placeholder' => __('messages.please_select'),
                ]) !!}

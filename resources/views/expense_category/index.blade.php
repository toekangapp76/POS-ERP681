...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('expense.expense_categories')
            <small
                class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">@lang('expense.manage_your_expense_categories')</small>
        </h1>
    </section>
    ...
    <section class="content">
        ...
        @slot('tool')
        <div class="box-tools">
            <a href="{{ route('expense-categories.diagnose') }}"
                class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-info tw-font-bold tw-rounded-full pull-right tw-mr-2">
                <i class="fas fa-stethoscope"></i> Diagnosa P&L Bisnis
            </a>

        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        ], $class->class_type ?? 'gym', ['class' => 'form-control', 'required']) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        ], $class->default_duration ?? 60, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('capacity', __('gym::lang.capacity')) !!}
                        {!! Form::number('capacity', $class->capacity, [
                            'class' => 'form-control',
                            'min' => 1,
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('price_per_hour', $class->price_per_hour ?? 0, [
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::number('min_booking_hours', $class->min_booking_hours ?? 1, [
                            'class' => 'form-control',
                            'min' => 1,
                            'max' => 24,
                        ]) !!}
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::number('max_booking_hours', $class->max_booking_hours ?? 4, [
                            'class' => 'form-control',
                            'min' => 1,
                            'max' => 24,
                        ]) !!}
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::number('advance_booking_days', $class->advance_booking_days ?? 7, [
                            'class' => 'form-control',
                            'min' => 1,
                        ]) !!}
                    </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::number('max_reschedule', $class->max_reschedule ?? 2, [
                            'class' => 'form-control',
                            'min' => 0,
                        ]) !!}
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::number('cancellation_hours', $class->cancellation_hours ?? 24, [
                            'class' => 'form-control',
                            'min' => 0,
                        ]) !!}
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::color('color', $class->color ?? '#667eea', [
                            'class' => 'form-control',
                        ]) !!}
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('has_courts', 1, $class->has_courts ?? false) !!}
                ...
                <div class="col-sm-6">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('is_active', 1, $class->is_active ?? true) !!}

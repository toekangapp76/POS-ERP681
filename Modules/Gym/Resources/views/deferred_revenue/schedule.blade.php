        ...
        <div class="box-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr class="{{ $schedule->status === 'recognized' ? 'success' : ($schedule->status === 'pending' && $schedule->recognition_date <= now() ? 'warning' : '') }}">
                        <td>{{ $index + 1 }}</td>
                        ...
                        <td class="text-right"><strong>{{ number_format($schedule->recognition_amount, 2, ',', '.') }}</strong></td>
                ...
                <tfoot>
                    <tr class="info">
                        ...
                        <th class="text-right">{{ number_format($schedules->sum('recognition_amount'), 2, ',', '.') }}</th>
                        <th colspan="2"></th>
                    </tr>
                </tfoot>
            </table>

    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {!! Form::select('gym_category_id', $gym_categories, null, [
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('deposit_account_id', $accounting_accounts, null, [
                                    'class' => 'form-control select2',
                                    'style' => 'width: 100%',
                                    'placeholder' => __('messages.please_select'),
                                ]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('enable_deferred_revenue', 1, true, ['class' => 'input-icheck']) !!}

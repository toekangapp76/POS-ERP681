        ...
        <div class="col-xs-12 pos-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center">@lang('accounting::lang.expenses')</a>
                    <a href="#" class="list-group-item text-center">@lang('gym::lang.gym')</a>
                </div>
            </div>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                @include('accounting::transactions.partials.gym_subscriptions')
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready( function(){
        ...
        gym_subscription_table = $('#gym_subscription_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '/accounting/transactions?datatable=gym_subscription',
                data: function(d) {
                },
            },
            aaSorting: [[1, 'desc']],
            ...
            { data: 'package_name', name: 'gp.name' },
